...
description:    This is a sample usage of the ModuleWriteError demonstrating the output and what is gets written to an ErrorVariable or the $Global:Error queue.
