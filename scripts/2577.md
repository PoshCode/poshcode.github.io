...
children:       
poster:         Paul Drinnon
title:          AnalyzeScript.ps1
date:           2011-03-24 08:25:39
description:    AnalyzeScript opens a dialog box for user selection; checks that input is a powershell script; parses and agrigates the script components. 
format:         posh
---
