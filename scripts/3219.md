...
date:           2012-02-09 21:50:02
description:    An upgrade to my wget script which can output the downloaded html to the pipeline. Get-WebFile can download text or binary files, automatically determine file names, and present a progress report for large files... branch 3.7.3 - tries to prevent problems involving bad URL formatting
format:         posh
---

# Get-WebFile 3.7.3

### [download](3219.ps1) [parent](3218.md) [3225](3225.md)
