...
children:       
poster:         Joel Bennett
title:          New-ElevatedTask 2.7
date:           2009-09-02 22:14:50
description:    Creates a new "On Demand Only" scheduled task to run an "Elevated" application, and a shortcut to launch it on demand, so you can bypass UAC prompting on specific apps.
format:         posh
---

# New-ElevatedTask 2.7

### [download](1301.ps1) [parent](907.md) 
