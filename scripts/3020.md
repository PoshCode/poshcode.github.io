...
poster:         Boe Prox
title:          Test-Port
date:           2011-10-21 18:34:16
description:    Advanced function used to test UDP or TCP port/s on one or more systems to determine if it is open or not.

21OCT2011: Fixed a bug in the way the UDP port is tested.
format:         posh
---

# Test-Port

### [download](3020.ps1) [parent](2514.md) 
