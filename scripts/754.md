...
description:    *Authenticode 1.6 for _CTP3_:* Now with integrated help. *_NOTE_*: The default cert should be put in a ModuleInfo file, but it will work without that, and will prompt you for a certificate (and/or the password for it) only once per session.
...
### [download](754.ps1) [parent](749.md) [1111](1111.md)
