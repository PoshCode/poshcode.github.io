...
description:    Speaks text using Speech.Net (requires .Net 3.0 or higher) text-to-speech api (if you don't have .Net 3.x, please just use the old one that uses the COM objects.
