...
children:       
poster:         steve_o
title:          Backup Rotation (7zip)
date:           2012-04-04 08:52:17
description:    This is a utility that uses 3 CSV(Text) files as drivers to name backups, associate them with files or folders, and to specify a number of versions to retain for each.  Backups are deleted on the next run of the utility.  7zip is required. 
format:         posh
---
...
This is a utility that uses 3 CSV(Text) files as drivers to name backups, associate them with files or folders, and to specify a number of versions to retain for each.  Backups are deleted on the next run of the utility.  7zip is required. 
