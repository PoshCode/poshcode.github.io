...
description:    This pair of PowerShell functions enables remote scanning/downloading of event logs with the ability to exclude specific events. - Uses PowerShell Remoting with Invoke-Command along with Get-EventLog and the spattering technique to pass arguements to the remote script block.
format:         posh
---
