...
description:    DekiWiki module, a package of a few script cmdlets (more to come, I promise) for working with DekiWiki. Included so far: Set-DekiCredential, Get-DekiContent, Set-DekiContent, New-DekiContent, Get-DekiFile ... conspicuously absent: Add-DekiFile, Remove-DekiFile, Remove-DekiContent ...
