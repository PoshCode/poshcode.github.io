...
children:       1966
poster:         Joel Bennett
title:          Get/Set Signature 2.4
date:           2010-07-09 20:02:28
description:    *Changes:* Added a -Module parameter to Set-AuthenticodeCertificate to make signing whole modules easier.

Has improved automatic cert picking and finding, allows wildcards for cert thumbprints and file names. Saves the selected cert as the *default* cert so you don't have to pick it each time. 
...
# Get/Set Signature 2.4

### [download](1965.ps1) [parent](1882.md) [1966](1966.md)
