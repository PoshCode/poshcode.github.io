...
poster:         Joel Bennett
title:          Ring Monitor
date:           2009-07-23 23:58:23
description:    Creates a self-updating graphical monitor which can chart pretty much anything that has a time-interval on it. You can use Add-Monitor and Remove-Monitor to add and remove things to be charted and specify what the data will be. See Examples at the bottom.
