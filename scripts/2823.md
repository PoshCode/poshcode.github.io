...
description:    Script to compare the printers on two Windows print clusters.  Great for verifying a migration or a backup cluster.  It performs basic comparisons on several printer attributes including name, share name, location, driver, and port information and outputs the results to the console.
format:         posh
---
