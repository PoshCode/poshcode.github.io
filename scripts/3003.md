...
date:           2011-10-14 06:34:38
description:    Windows Script to collect Hardware information on a local system and Convert it to a JSON String and Upload that to a CouchDB Database
format:         posh
---
