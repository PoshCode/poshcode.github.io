...
poster:         JohnyMac
title:          
date:           2008-09-07 13:03:06
description:    Code to auto update the Address policy, GAL, OAB and storage groups and mailbox databases of an Exchange 2007 server
This code is good for hosting providers or people who wish to use lots of storage groups and mailbox databases.
In a nutshell it automatically increments the storage group for new customers so you don't have to manually create mailbox databases.  
We use it along side Jaykuls get-mysqldatatableset to automatically generate customers from a mysql database.	
...
### [download](569.ps1) [parent](568.md) [570](570.md)
