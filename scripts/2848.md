...
### [download](2848.ps1) - [parent](2847.md) - children: [2849](2849.md)
...
Run with -h option for help and usage. Options include -u to add files and update modified files to a database, -e to exclude directories, -c to create a database, -x to specify a .xml file to create/use. Subdirs are automatically processed.
