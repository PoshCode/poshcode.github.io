...
poster:         Jim Ficarra
title:          Write-Log
date:           2014-10-29 22:15:40
description:    Corrected syntax to delete the FileCountLimit'th file.  (Script was failing to write past the max # of files)
format:         posh
---

# Write-Log

### [download](5553.ps1) [parent](5552.md) [5554](5554.md)

Corrected syntax to delete the FileCountLimit'th file.  (Script was failing to write past the max # of files)
