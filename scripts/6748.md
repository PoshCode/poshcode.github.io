...
date:           2017-02-23 13:06:35
description:    ping-computer is not a standard Powershell command...  replace line 54 with if (test-connection $srv -count 1).protocolAddress
format:         posh
---

# Check Server Health

### [download](6748.ps1) [parent](820.md) 
