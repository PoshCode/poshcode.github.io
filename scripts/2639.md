...
description:    Converts objects to custom PSObjects with robust type support. Allows converting data from Import-CSV etc into type-safe pseudo structs ...
format:         posh
---

# ConvertTo-PseudoType

### [download](2639.ps1)  [2640](2640.md)
