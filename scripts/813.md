...
### [download](813.ps1) - [parent](806.md) - children: [846](846.md)

Ported TabExpansion from V2CTP2 to v1.0 and extended. 
Update:
#Doesn't need Get-PipelineObject.ps1 (it was embedded)
#Doesn't soil $PSHOME\profile.ps1

#.Net and WMI class name expansion is now gradable
New-Object System.win<tab>.for<tab>.bu<tab>
[system.Man<tab>.auto<tab>.p<tab>
gwmi win<tab>_perfFor<tab>_<tab>_p<tab>_log<tab>

#.Net class name expansion now also shows type accelerators 
[wmise<tab>
New-Object -t ha<tab>
