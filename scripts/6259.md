...
description:    Get-Large-Pics.ps1 - scans a source directory's pictures and stores the largest version it can find in google image search is target directory. Usage: get-large-pics.ps1 c:\pictures c:\results.
format:         posh
---

# Get-Large-Pics.ps1

### [download](6259.ps1)  [6260](6260.md)
