...
description:    Required types for ModuleWriteError.psm1.  Adds Verb, Noun, Prefix, and InternalName fields to the FunctionInfo object for advanced functions.
format:         posh
---

# FuncionInfo.types.ps1xml

### [download](1571.ps1)  [1575](1575.md)
