...
children:       5207,5206
poster:         jgrote
title:          PlexMediaAutoRetire
date:           2014-06-03 19:53:45
description:    Script to use the Plex API to detect watched shows and either archive them to a different folder or remove them.
format:         posh
---

# PlexMediaAutoRetire

### [download](5205.ps1)  [5207](5207.md) [5206](5206.md)

Script to use the Plex API to detect watched shows and either archive them to a different folder or remove them.
