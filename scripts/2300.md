...
poster:         Joel Bennett
title:          Write-Output
date:           2010-10-14 10:25:16
description:    A Write-Output replacement with the option to output collections that don't unwrap.

_Simplified the parameters to just -AsCollection_
format:         posh
---

# Write-Output

### [download](2300.ps1) [parent](2299.md) 
