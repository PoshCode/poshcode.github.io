...
date:           2011-04-27 22:57:22
description:    Converts objects to custom PSObjects with robust type support. Allows converting data from Import-CSV etc into type-safe pseduo structs ...
format:         posh
---
