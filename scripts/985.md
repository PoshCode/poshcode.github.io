...
poster:         tojo2000
title:          SMS.psm1
date:           2009-03-31 00:48:27
description:    Module with functions to make it easy to query the SMS provider directly through WMI.  (Updated for PowerShell v2 w/auto-help).  Update the $default_wmi_provider_server and $default_site variables to match your environment.
format:         posh
---

# SMS.psm1

### [download](985.ps1) [parent](597.md) [986](986.md)
