...
date:           2013-07-26 18:42:17
description:    Will capture failed and Successful logins for a remote server for the last 24 hours and email to user. Utilizes Get-eventlog for Server 2003.
format:         posh
---

# Security Log Events

### [download](4338.ps1)  [4339](4339.md)

Will capture failed and Successful logins for a remote server for the last 24 hours and email to user. Utilizes Get-eventlog for Server 2003.
