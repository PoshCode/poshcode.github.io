...
children:       5552
poster:         Jim Ficarra
title:          Write-Log updt 2014Oct29
date:           2014-10-29 21:32:35
description:    Update to Write-Log.  In line 55 $Parameters = $PSBoundParameters.Clone(), the Clone() method is not available in PowerShell 4.0. Replaced with $Parameters = @{} + $PSBoundParameters
format:         posh
---

# Write-Log updt 2014Oct29

### [download](5551.ps1) [parent](4066.md) [5552](5552.md)

Update to Write-Log.  In line 55 $Parameters = $PSBoundParameters.Clone(), the Clone() method is not available in PowerShell 4.0. Replaced with $Parameters = @{} + $PSBoundParameters
