...
date:           2013-02-18 07:35:43
description:    This is a Windows startup script with pop-up notification and checks to assure things are not executed if already running or set.  It can be run as a personal startup script or as a domain startup (with some editing).  It's an updated version of the one I posted here previously.
format:         posh
---

# Windows Startup Script

### [download](3956.ps1) [parent](3955.md) [4006](4006.md)

This is a Windows startup script with pop-up notification and checks to assure things are not executed if already running or set.  It can be run as a personal startup script or as a domain startup (with some editing).  It's an updated version of the one I posted here previously.
