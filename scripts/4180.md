...
children:       
poster:         not_laughing
title:          Example user addition 
date:           2013-05-22 20:25:21
description:    User addition for Exchange/AD/Lync. Still work in progress, as all of the Lync functionality is not quite implemented. For example only, run at your own risk. 
format:         posh
---

# Example user addition 

### [download](4180.ps1) [parent](4179.md) 
