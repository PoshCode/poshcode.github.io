...
poster:         AllanData
title:          Start-rdp.ps1
date:           2013-04-03 13:06:10
description:    script to wrap arround mstsc.exe and start miltiple rdp sesions in one command
format:         text
---

# Start-rdp.ps1

### [download](4067.txt)  [4068](4068.md)

script to wrap arround mstsc.exe and start miltiple rdp sesions in one command
