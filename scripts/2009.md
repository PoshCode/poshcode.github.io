...
children:       
poster:         Joel Bennett
title:          Get-Desktop.ps1
date:           2010-07-22 21:00:15
description:    4 lines of PowerShell to wrap that C# class and show you how to use it... (with Add-Type -Path)
format:         posh
---

# Get-Desktop.ps1

### [download](2009.ps1) [parent](2008.md) 
