...
date:           2010-07-09 08:29:43
description:    ConvertFrom-PropertyString can convert ini files, property files, and other flat key-value data strings into PSObjects. v2 changes the output so that if there are multiple instances of the same key, we collect the values in an array
format:         posh
---

# ConvertFrom-Property

### [download](1956.ps1) [parent](1915.md) [2050](2050.md)
