...
children:       
poster:         Jon Webster
title:          Join-Collections 2.1
date:           2010-02-23 15:05:31
description:    Performs an inner join on two collections of objects which share a common key value. Now works on DataTable objects (ie: can join the rows from two tables).
Version 2.1 Uses a hashtable to improve join performance significantly
format:         posh
---

# Join-Collections 2.1

### [download](1654.ps1) [parent](1461.md) 
