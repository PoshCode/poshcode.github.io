...
description:    V2 advanced Function based off http://tinyurl.com/yabqtgy.... an example of how parameter binding/validation/parameter sets can really enhance even a simple script.
format:         posh
---

# Move-Template

### [download](1600.ps1) [parent](1599.md) 
