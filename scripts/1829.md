...
children:       1830
poster:         Joel Bennett
title:          Autoload (beta 3)
date:           2010-05-10 09:49:04
description:    The Autoload functionality of the Korn shell -- Now Module compatible.

This release works around a bug where signed scripts couldn't be loaded into modules
format:         posh
---

# Autoload (beta 3)

### [download](1829.ps1) [parent](1828.md) [1830](1830.md)
