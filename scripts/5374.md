...
description:    Your first steps at capturing packets from PowerShell with "WinPcap":http://www.winpcap.org/install/default.htm via "SharpPcap":http://sourceforge.net/projects/sharppcap/
format:         posh
---
