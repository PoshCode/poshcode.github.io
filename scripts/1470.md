...
description:    *Authenticode 1.8 for PowerShell 2.0:* The default cert should be put in a ModuleInfo file, but it will work without that, and will prompt you for a certificate (and/or the password for it) only once per session.
...
### [download](1470.ps1) [parent](1111.md) [1473](1473.md)
