...
description:    Cmdlet Find-TaskServiceUser was written to find scheduled tasks and/or services on remote/local computer with specific user (owner). User 'Administrator' and localhost are default.
