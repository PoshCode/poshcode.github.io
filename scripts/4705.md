...
description:    My command prompt, as always. I leave this in _a separate script file_ and invoke it from my profile. That way I can RE-invoke it to reset my prompt if I have to mess with it for some reason.
...
### [download](4705.ps1)  [6338](6338.md)
