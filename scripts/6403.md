...
description:    Reads from the registry all the .Net versions installed on the local machine and displays them in HTML page
format:         posh
---

# Show-MyDotNetVersions

### [download](6403.ps1) [parent](6402.md) [6435](6435.md)
