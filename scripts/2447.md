...
description:    This is a *batch* file ... with a PowerShell script inside.  It's my answer to all those "compile your .ps1" solutions that are floating around. Why would you do that, when PowerShell still has to be installed?
