...
children:       
poster:         Joel Bennett
title:          SyntaxHighlighter Brush
date:           2009-05-12 14:03:33
description:    A PowerShell 2.0 Brush for the javascript "SyntaxHighlighter":http://alexgorbatchev.com/wiki/SyntaxHighlighter

Updated to correctly highlight the - and not screw up angle brackets > in scripts.
format:         javascript
---

# SyntaxHighlighter Brush

### [download](1097.js) [parent](1014.md) 

A PowerShell 2.0 Brush for the javascript "SyntaxHighlighter":http://alexgorbatchev.com/wiki/SyntaxHighlighter
