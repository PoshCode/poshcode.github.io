...
description:    This *MANDATORY UPGRADE* ;-) fixes a bug which breaks Get-Parameter if you run it against the same command twice.
...
### [download](2030.ps1) [parent](2007.md) [2031](2031.md)
