...
children:       
poster:         Joel Bennett
title:          Remove-DownloadFlag
date:           2009-10-28 23:40:14
description:    Allows setting *and removing* the Zone.Identifier alternate data stream (on NTFS file systems) which flags scripts as downloaded to heighten security. Part of the PoshCode Module.
format:         posh
---
