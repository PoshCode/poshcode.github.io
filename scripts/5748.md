...
date:           2015-02-20 21:52:13
description:    Creates an error record for throwing better/customized errors in scripts/modules.
format:         posh
---

# New-ErrorRecord

### [download](5748.ps1)  [5749](5749.md)

Creates an error record for throwing better/customized errors in scripts/modules.
