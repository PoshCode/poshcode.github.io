...
children:       
poster:         Jeff Patton
title:          Get-ComputerUpdateRport
date:           2011-08-09 10:54:09
description:    This script uses two functions to get a list of computers from ActiveDirectory and then query each computer for a list of pending updates. It then returns selected fields from that function to create the report.
format:         posh
---
