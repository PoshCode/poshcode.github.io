...
parent:         0
children:       
poster:         Heath Stewart
title:          Feeds Module
date:           2009-05-29 12:57:44
description:    A script module that allows you to sync feeds using the Microsoft Feeds Manager automation API, as well as mark items read for all or specific folders.
format:         posh
---
