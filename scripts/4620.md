...
description:    PS Tools has nothing to do with Sysinternals Suite except for the name. This GUI script simplifies navigation on the methods and properties of the WMI classes and assembles which has been loaded into AppDomain at current moment.
format:         posh
---
