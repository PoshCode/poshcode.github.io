...
children:       
poster:         Joel Bennett
title:          ConsoleHelper.psm1
date:           2013-11-12 20:37:08
description:    Some helper functions for getting/setting the output buffer and command history size in PowerShell.exe native.
format:         posh
---
