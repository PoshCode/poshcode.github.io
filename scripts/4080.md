...
children:       
poster:         Joel Bennett
title:          ConvertFrom-Property 3.7
date:           2013-04-07 00:57:17
description:    ConvertFrom-PropertyString 3.7 can convert ini files, property files, and other flat key-value data strings into PSObjects. 
...
* v3.7 is a minor update to support properties without values
format:         posh
---

# ConvertFrom-Property 3.7

### [download](4080.ps1) [parent](3546.md) 
