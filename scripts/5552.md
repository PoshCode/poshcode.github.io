...
description:    2nd Update to Write-Log (messed up post).  In line 55 $Parameters = $PSBoundParameters.Clone(), the Clone() method is not available in PowerShell 4.0. Replaced with $Parameters = @{} + $PSBoundParameters
format:         posh
---

# Write-Log 2014Oct29

### [download](5552.ps1) [parent](5551.md) [5553](5553.md)
