...
poster:         Chad Miller
title:          RunSSIS
date:           2009-02-23 08:34:59
description:    Executes a SQL Server Integrations Services package for both server and file system storage types. Also includes optional processing of external configuration file.
format:         posh
---

# RunSSIS

### [download](889.ps1) [parent](842.md) 
