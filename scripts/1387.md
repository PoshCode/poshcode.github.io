...
poster:         karaszmiklos
title:          
date:           2009-10-12 06:45:48
description:    I like using runas.exe to elevate a process (like su in unix/linux) but runas /savecred and saving credentials can be "disabled" by policy. That's why i use su.ps1 through su.bat instead of runas.exe. Several idea has been implemented from other posts. Thank you for their/your help:
http://halr9000.com/article/531		http://blogs.microsoft.co.il/blogs/ScriptFanatic/
format:         posh
---
...
I like using runas.exe to elevate a process (like su in unix/linux) but runas /savecred and saving credentials can be "disabled" by policy. That's why i use su.ps1 through su.bat instead of runas.exe. Several idea has been implemented from other posts. Thank you for their/your help:
http://halr9000.com/article/531		http://blogs.microsoft.co.il/blogs/ScriptFanatic/
