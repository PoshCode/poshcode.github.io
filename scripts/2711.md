...
date:           2011-06-07 06:25:51
description:    This pair of PowerShell functions enables remote scanning/downloading of event logs using with the ability to exclude specific events. - Uses PowerShell Remoting with Invoke-Command along with Get-EventLog and the spattering technique to pass arguements to the remote script block.
format:         posh
---

# Scan Remote Event Logs

### [download](2711.ps1)  [2712](2712.md)
