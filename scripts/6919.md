...
children:       
poster:         dsadsadsada
title:          Invoke-WindowsUpdate
date:           2017-06-01 05:45:28
description:    Script to download and install updateseporting and rebooting may be customized.
For more details, see the following blog-post:  from Windows Update/WSUS. R
...
### [download](6919.ps1) [parent](1932.md) 

Script to download and install updateseporting and rebooting may be customized.
For more details, see the following blog-post:  from Windows Update/WSUS. R
http://blog.powershell.no/2010/06/25/manage-windows-update-installations-using-windows-powershell
