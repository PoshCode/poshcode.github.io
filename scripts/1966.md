...
children:       
poster:         Joel Bennett
title:          Get/Set Signature 2.5
date:           2010-07-09 21:42:46
description:    The improved code-signing module with automatic cert picking and finding. 

The Authenticode module supports wildcards for cert thumbprints and for file names. It offers to save the selected cert as the *default* cert so you don't have to pick it each time, and it defaults to using a Time Stamp server when signing so your signed scripts will outlive your certificate.

*Changes in this version:* 

* Added a -Module parameter to Set-AuthenticodeCertificate to make signing whole modules easier.
* Added support for configuring different default certificates for multiple computers in one psd1 PrivateData
...
# Get/Set Signature 2.5

### [download](1966.ps1) [parent](1965.md) 
