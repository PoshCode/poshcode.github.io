...
parent:         0
children:       
poster:         Tobias Weltner
title:          MVP PowerShell
date:           2012-09-20 07:33:43
description:    Four functions for manipulating ISE settings (ISE 3.0, requires PowerShell v3):
Get-ISESetting
Set-ISESetting
Get-ISEMRUList
Set-ISEMRUList
...
Four functions for manipulating ISE settings (ISE 3.0, requires PowerShell v3):
Get-ISESetting
Set-ISESetting
Get-ISEMRUList
Set-ISEMRUList
