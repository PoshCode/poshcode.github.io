...
poster:         foobar
title:          TabExpansion
date:           2009-05-30 10:25:40
description:    Ported TabExpansion from V2CTP2 to v1.0 and extended.  Please dot souce this script file to use.
# Using Ctrl+K, charactors insertion (bihind space or semi-coron or pipe operator) feature : it encloses tokens with parnthesis by default
 1 - 1 - 1 - 1<Ctrl+K><tab> 
 1 - 1 - 1 - (1)<tab> 
 1 - 1 - 1 (- 1)<tab> 
 1 - 1 - (1 - 1)<tab><tab><tab>... 
...
if there is a charactor between <Ctrl+K> and  <tab>, it is inserted between tokens 
 1+1 | {$_*2}<Ctrl+K>%<tab> 
 1+1 | %{$_*2} 
...
if the charactor is ( or { or {, tokens are enclosed ( ) or { } or {} 
 int<Ctrl+K>[<tab> 
 [int] 

with double Ctrl+K, and if there is a charactor between <Ctrl+K> and  <tab>, it is inserted between tokens with '$' 
...
### [download](1137.ps1) [parent](1126.md) [1180](1180.md)
