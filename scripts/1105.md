...
children:       1107
poster:         Joel Bennett
title:          HttpRest 1.1.0
date:           2009-05-14 21:20:07
description:    First STEP of Reworking in PowerShell 2.0 with parameter sets, etc.

OLD documentation on "this post on HuddledMasses":http://huddledmasses.org/using-rest-apis-from-powershell-with-the-dream-sdk/
format:         posh
---

# HttpRest 1.1.0

### [download](1105.ps1) [parent](1104.md) [1107](1107.md)
