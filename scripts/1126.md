...
# Better type literal expansion with no spaces
[in<tab>[st<tab>[system<tab>

# Better expansion when the line include quortation mark
== before ==
 echo "powershell"|te<tab>
 echo "powershell|tee"
== after ==
 echo "powershell"|te<tab>
 echo "powershell"|tee
...
### [download](1126.ps1) [parent](977.md) [1137](1137.md)
