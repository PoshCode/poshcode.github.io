...
date:           2013-07-24 02:10:02
description:    Works very much like write-host but easily can change the colors of texts using color codes in the string.  Supports using pipeline as well to remove the color code from the string that being pass down to next pipeline.
format:         posh
---

# Write-MixColorsHost

### [download](4328.ps1) [parent](4327.md) 
