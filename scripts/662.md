...
parent:         0
children:       
poster:         Markus Laumann
title:          AD Exch Users to Groups
date:           2008-11-07 10:06:56
description:    Search Active Directory for all users,
add them to specific groups based on homemta value,
remove disabled users from same groups,
and export all users to excel. 
format:         posh
---

# AD Exch Users to Groups
