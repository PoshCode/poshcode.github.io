...
title:          Get-PEDump
date:           2014-03-13 14:23:47
description:    It's an idea how to parse some data of PE headers without additional assemblies. The script is not fully finished and it's for intermediate testing.
format:         posh
---
...
It's an idea how to parse some data of PE headers without additional assemblies. The script is not fully finished and it's for intermediate testing.
