...
<#
.SYNOPSIS
Example for Automatic Programming of Transact-SQL code using SQL Server Managment Objects (SMO)
...
"@
          ...
          <#+----------------------------------------------------------------------------------------------+#&#707;
            | Loop through the columns in the table, adding each to the select statment                    |
          &#706;#+----------------------------------------------------------------------------------------------+#>  
          $_.Columns | where {!$_.IsSystemObject} | 
            % {
                if($IsFirst)
...
"@
          ...
          <#+--------------------------------------------------------------------+#&#707;
            | Finilize the create view statment for this table                   |
          &#706;#+--------------------------------------------------------------------+#>
          $TSQL += @"
  FROM
