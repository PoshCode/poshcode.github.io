...
children:       
poster:         Jeff Patton
title:          Get-GPOSettings
date:           2011-08-18 14:41:29
description:    This script gets a list of all Group Policy Objects in the domain filtered on the value of GPOSettingName. For each GPO if the Extension Name matches GPOSettingName the Extensions are then reported back. 
format:         posh
---
