...
children:       
poster:         Wayne Martin
title:          PS FindFirstFileW
date:           2008-05-23 15:01:30
description:    Use the wide unicode versions (FindFirstFileW and FindNextFileW) to report a directory listing of all files, including those that exceed the MAX_PATH ANSI limitations
format:         posh
---

# PS FindFirstFileW

### [download](408.ps1) [parent](401.md) 
