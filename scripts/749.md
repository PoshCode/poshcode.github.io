...
date:           2008-12-26 16:21:06
description:    *VERSION 1.5 for _CTP3_* -- The default cert should be put in the ModuleInfo file.
...
### [download](749.ps1) [parent](464.md) [754](754.md)

*VERSION 1.5 for _CTP3_* -- The default cert should be put in the ModuleInfo file.
