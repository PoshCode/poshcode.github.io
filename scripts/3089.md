...
description:    Inspired by "Jeff Hicks's Friday Fun post":http://jdhitsolutions.com/blog/2011/12/friday-fun-drive-usage-console-graph/ I thought I'd do the graphs purely as an output format.  All you have to do is @Update-FormatData -Prepend .\DriveSpace.format.ps1xml@ and then any time you have a Win32_LogicalDisk output it will show up as a bar graph. Try this: @get-wmiobject -Class Win32_logicaldisk -filter "Size>0"@
format:         xml
---

# DriveSpace.format.ps1xml

### [download](3089.xml)  [3090](3090.md)
