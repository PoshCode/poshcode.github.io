...
### [download](2981.ps1) - children: [2982](2982.md)
...
begin {
	...
	# C# Code to P-invoke LSA LsaStorePrivateData function.
	Add-Type @"
		using System;
...
process {
	...
	try {
		...
		Set-ItemProperty -Path $WinlogonPath -Name AutoAdminLogon -Value $Enable -Force -ErrorAction Stop
		...
		if ($AutoLogonCount) {
			Set-ItemProperty -Path $WinlogonPath -Name AutoLogonCount -Value $AutoLogonCount -Force -ErrorAction Stop
		} else {
...
<#
	...
	.EXAMPLE
		PS C:\> Set-AutoLogon `
				...
				-AutoLogonCount 2 `
				-RemoveLegalPrompt `
				-BackupFile "$scriptHome\WinlogonBackup.xml"
