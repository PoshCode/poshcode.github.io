...
date:           2016-03-19 17:28:34
description:    Get-Large-Pics.ps1 - scans a source directory's pictures and stores the largest version of each picture it can find in google image search in the target directory. Usage: get-large-pics.ps1 c:\pictures c:\results.
format:         posh
---

# Get-Large-Pics.ps1

### [download](6261.ps1) [parent](6260.md) [6262](6262.md)

Get-Large-Pics.ps1 - scans a source directory's pictures and stores the largest version of each picture it can find in google image search in the target directory. Usage: get-large-pics.ps1 c:\pictures c:\results.
