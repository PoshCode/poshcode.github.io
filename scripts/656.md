...
children:       
poster:         tojo2000
title:          Get-DefragAnalysis.ps1
date:           2008-11-04 03:07:28
description:    Displays disk fragmentation statistics for a remote server.  My first attempt at using Windows Forms with PrimalForms.  Edit: fixed spacing.
format:         posh
---

# Get-DefragAnalysis.ps1

### [download](656.ps1) [parent](655.md) 
