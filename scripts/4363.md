...
date:           2013-08-05 14:23:01
description:    This function retrieves a Windows product key from registry on specified computers (host is specified by default) and some additional info.
This version of algorithm is compliant with Windows 8 style keys (which contains 'N' character).
format:         posh
---
...
This function retrieves a Windows product key from registry on specified computers (host is specified by default) and some additional info.
This version of algorithm is compliant with Windows 8 style keys (which contains 'N' character).
