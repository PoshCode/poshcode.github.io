...
description:    *Authenticode 2.2* Improved automatic cert picking, and serializing the selected cert as the *default* cert so you don't have to pick it each time. 
...
### [download](1580.ps1) [parent](1473.md) [1882](1882.md)
