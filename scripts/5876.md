...
children:       
poster:         Kurt Falde
title:          Evt XPath Creation
date:           2015-05-28 04:43:32
description:    Parses a Windows Event log entry by specifying EventRecordID and Log name and outputs XPath that can be used in an event filter/view or Windows Event Forwarding Filter
format:         posh
---
