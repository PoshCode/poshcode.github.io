...
description:    Cmdlet Find-TaskServiceUser was wrote to find scheduled tasks and/or services on remote/local computer with specific user (owner). User 'Administrator' and localhost are default.
...
### [download](5146.ps1)  [5147](5147.md)
