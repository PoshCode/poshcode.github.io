...
poster:         Wizarden
title:          TSRemoteApp
date:           2010-11-22 11:34:38
description:    Module gives functions for managing RemoteApp on Windows 2008 and Windows 2008 R2.
You can Create,Remove and list RemoteApps. Also You can Import and Export Settings and RemoteApps, using TSPUB-file, which used in Terminal Services.
format:         posh
---
