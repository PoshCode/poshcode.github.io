...
description:    Set-Wallpaper lets you set your windows desktop wallpaper.  It *requires PInvoke* and I wrote it using CTP2's @Add-Type@, although it could be done in v1 using the JIT code generation tricks Lee Holmes has mentioned in the past ...
...
### [download](491.ps1) [parent](488.md) [815](815.md)
