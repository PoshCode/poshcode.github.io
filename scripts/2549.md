...
description:    This script cycle through an entire VMware Virtual Center instance and identify any virtual machines that are "invald" or "inaccessible".  This typically occurs as a result of a host crash.  Running VMs are left with lock files in place making them unusable.  The script is internally documented and has lots of status available.  Use at your own risk
format:         posh
---
