...
description:    This is a variant of ISE-Snippets which determines the snippet based on selectes text or if nothing is selected bases on the text left to the carret.
