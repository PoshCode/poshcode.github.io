...
title:          peheaders.cmd
date:           2014-04-07 10:40:37
description:    See original post at [Gist](https://gist.github.com/gregzakharov/10017994)
Save file with .cmd\.bat extension, place it into any %PATH% directory and try it. For example:
**C:\> peheaders /o:%windir%\explorer.exe**
Dumps optional header of Explorer.exe
Or
**C:\> peheaders /s:%windir%\notepad.exe**
Shows sections of notepad.exe
format:         text
---
...
See original post at [Gist](https://gist.github.com/gregzakharov/10017994)
Save file with .cmd\.bat extension, place it into any %PATH% directory and try it. For example:
**C:\> peheaders /o:%windir%\explorer.exe**
Dumps optional header of Explorer.exe
Or
