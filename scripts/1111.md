...
description:    *Authenticode 1.7 for _CTP3_:* Now with integrated help. *_NOTE_*: The default cert should be put in a ModuleInfo file, but it will work without that, and will prompt you for a certificate (and/or the password for it) only once per session.
...
### [download](1111.ps1) [parent](754.md) [1470](1470.md)
