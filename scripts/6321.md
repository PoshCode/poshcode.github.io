...
title:          Async Pipeline WPF GUI
date:           2016-04-25 13:58:46
description:      How to create a non blocking Graphical User Interface (GUI) with Windows Presentation Foundation (WPF)
  and how to write Data with PowerShell to GUI controls correctly with the dispatcher from a different thread (Runspace).
format:         posh
---
