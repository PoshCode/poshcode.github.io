...
poster:         Jeff Patton
title:          Get-SiSReport
date:           2011-07-27 09:31:42
description:    This function returns the sisadmin /v status and basic disk information for a given disk. Now handles C or C:
format:         posh
---

# Get-SiSReport

### [download](2853.ps1) [parent](2777.md) 
