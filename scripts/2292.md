...
children:       
poster:         Joel Bennett
title:          CommandTranscript
date:           2010-10-08 10:37:10
description:    A module to log commands entered (like Start-Transcript, but without output).
This is useful when you want to create a script by typing in commands and allows you to go back later and delete extra commands from the script. Note that this can be used *in conjunction* with the regular full logging Start-Transcript.

Added commands to detect if a transcript is already running, and to find the location of the transcript log.
format:         posh
---

# CommandTranscript

### [download](2292.ps1) [parent](2291.md) 

A module to log commands entered (like Start-Transcript, but without output).
This is useful when you want to create a script by typing in commands and allows you to go back later and delete extra commands from the script. Note that this can be used *in conjunction* with the regular full logging Start-Transcript.
