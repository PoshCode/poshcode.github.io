...
description:    How do you know which hotfix or security fix is included in Windows 7 or Windows Server 2008 R2 SP1? This script downloads the necessary informations and puts it into objects, so you can query and work with it.
...
### [download](2709.ps1) [parent](2708.md) 
