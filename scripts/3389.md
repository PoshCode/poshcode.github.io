...
title:          Invoke-RemoteCommand
date:           2012-04-30 22:51:12
description:    This function will run code on a remote computer under the currently logged on user credentials. Knowing there password is not required as it will impersonate the windows token.
format:         posh
---

# Invoke-RemoteCommand

### [download](3389.ps1) [parent](3388.md) [3390](3390.md)
