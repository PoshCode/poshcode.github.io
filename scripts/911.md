...
description:    Function to retrieve all the CIFS shares, and their permissions on a NetApp SAN.  Function requires the NetApp OnTap SDK v3.5 which can be found http://communities.netapp.com/docs/DOC-1365.  More information about the SDK and it's use in PowerShell can be found http://get-admin.com/blog/?p=545
~Glenn
format:         posh
---
