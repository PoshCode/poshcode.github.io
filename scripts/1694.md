...
date:           2010-03-11 13:22:16
description:    Set-Computer gives a GUI to select a schedule and schedules a task using schtasks.  This is a beta.  There are still a lot of features to implement.  Please read through the synopsis->Description to see the list of features that I hope to get in a final release.
format:         posh
---

# Set-WinSchedule

### [download](1694.ps1) [parent](1693.md) [1695](1695.md)
