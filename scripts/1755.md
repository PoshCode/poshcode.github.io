...
description:    Find duplicates in <directorys> and all sub-directories. Usage: finddupe.ps1 <directory1> <directory2> ... <directory3>
format:         posh
---

# finddupe.ps1

### [download](1755.ps1) [parent](1754.md) [1756](1756.md)
