...
parent:         4304
children:       
poster:         SumuraiGiblet
title:          Get logged on Users
date:           2015-02-19 11:55:09
description:    Function to get all logged on sessions (numbers) and coresponding users (domain name) on a local or remote system with WMI
...
Amended as I found not every WMI instance of Win32_LogonSession has an associated Win32_LogonSession
format:         posh
---

# Get logged on Users

### [download](5742.ps1) [parent](4304.md) 
