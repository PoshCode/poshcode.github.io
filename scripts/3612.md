...
poster:         Huajun Gu
title:          New-XVM
date:           2012-09-04 20:36:42
description:    This is a script which I have used to prepare my lab environment with Hyper-V 3.0. I have tested it in Windows Server 2012 RC.
...
I know MemoryStartupBytes and BootDevice are not enough. There are a lot of new features in Hyper-V 3.0, right? :)
Like Bandwidith Management, DHCP Guard, Root Guard and so on.

Note: I haven't tried to run this script against a remote Hyper-V 3.0 server.
format:         posh
---

# New-XVM

### [download](3612.ps1) [parent](3611.md) [3613](3613.md)
