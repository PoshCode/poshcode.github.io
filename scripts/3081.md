...
children:       
poster:         Joel Bennett
title:          Set-SolarizedHostColor
date:           2011-12-04 10:41:54
description:    Set the colors for Solarized theme in PowerShell ISE (or in the PowerShell.exe console if started from a shortcut modified by "Install-Solarized":http://poshcode.org/3080)

See also the "Solarized Theme for ISE 3 (CTP2)":http://poshcode.org/get/3079
format:         posh
---

# Set-SolarizedHostColor

### [download](3081.ps1)  

Set the colors for Solarized theme in PowerShell ISE (or in the PowerShell.exe console if started from a shortcut modified by "Install-Solarized":http://poshcode.org/3080)
