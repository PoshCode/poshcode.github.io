...
poster:         Egil Aspevik
title:          xls2png
date:           2014-05-23 14:25:13
description:    Bulk converts XLS ranges to PNG by using the clipboard. Reads config from XML. 
format:         posh
---

# xls2png

### [download](5183.ps1)  [5184](5184.md)

Bulk converts XLS ranges to PNG by using the clipboard. Reads config from XML. 
