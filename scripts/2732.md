...
description:    A series of functions to verify Agent, SQL, SSIS, SMB, WMI services or connections. Useful when troubleshooting data center firewall configuration.
format:         posh
---

# Test-SqlConnection

### [download](2732.ps1) [parent](2722.md) 
