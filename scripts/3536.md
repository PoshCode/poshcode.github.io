...
description:    This script takes a list of Active Directory security group membership from XML, checks a baseline, and emails results.  Code can be taken from this to create the baseline XML as well.  Thanks to A.Metzger for fixing empty group membership bug.
