...
description:    Generates a CSR for submission to a public CA.  You will need to set the subject in the script, as the only variables are hostname, domainname, and inputfile.
format:         posh
---
