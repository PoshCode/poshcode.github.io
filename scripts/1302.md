...
poster:         Karl Prosser
title:          New-Shortcut
date:           2009-09-03 10:49:25
description:    A script to create shortcuts ... with support for short "special folder" names. (fixed) the [parameter named as [param bug
format:         posh
---

# New-Shortcut

### [download](1302.ps1) [parent](906.md) 
