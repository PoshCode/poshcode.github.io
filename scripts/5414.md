...
description:    Saturated addition, subtraction, multiplication, and casting from numeric types to integer types using clamping to handle overflows.
format:         posh
---

# Saturated arithmetic 2.0

### [download](5414.ps1)  [5415](5415.md)
