...
description:    Pastes text from clipboard into PowerShell host without Add-Type and Sytem.Windows.Forms classes (such as Clipboard and TextBox)
format:         posh
---

# paste

### [download](4749.ps1)  [4750](4750.md)
