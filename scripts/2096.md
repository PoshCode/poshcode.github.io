...
description:    This is my profile script ... it contains a few things that are specific to my setup (particularly: which modules I load, and the scripts which I Autoload), but they are all available here on PoshCode.org :-)
format:         posh
---

# My Profile.ps1

### [download](2096.ps1)  [6062](6062.md)
