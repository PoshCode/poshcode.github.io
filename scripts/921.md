...
children:       
poster:         glnsize
title:          OnTapSDK_Discoverability
date:           2009-03-08 08:08:34
description:    A couple functions to aid in the discoverability of the OnTap SDK. Functions requires the NetApp OnTap SDK v3.5 which can be found http://communities.netapp.com/docs/DOC-1365. More information about the SDK and it’s use in PowerShell can be found here http://get-admin.com/blog/?tag=ontap-sdk
~Glenn
format:         posh
---
...
A couple functions to aid in the discoverability of the OnTap SDK. Functions requires the NetApp OnTap SDK v3.5 which can be found http://communities.netapp.com/docs/DOC-1365. More information about the SDK and it’s use in PowerShell can be found here http://get-admin.com/blog/?tag=ontap-sdk
~Glenn
