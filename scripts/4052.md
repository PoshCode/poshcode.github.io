...
poster:         chriskenis
title:          GetSet-Users
date:           2013-03-27 19:15:46
description:    enumerate + add + remove users or groups to any local group on a local, single or multiple remote computers
needs remote admin rights obviously
format:         posh
---
