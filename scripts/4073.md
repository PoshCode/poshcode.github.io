...
date:           2013-04-05 03:34:51
description:    RESTful server in pure PowerShell. Does not require a webserver. Requires PowerShell v3.0
format:         posh
---

# RESTful Server

### [download](4073.ps1)  [5365](5365.md)

RESTful server in pure PowerShell. Does not require a webserver. Requires PowerShell v3.0
