...
Default help and man function now support topics and command expansion (with/without -Name parameter), and category expansion with -Category parameter
 help -Name <tab>
 man about_<tab>
 help -Category <tab>
...
### [download](880.ps1) [parent](846.md) [912](912.md)
