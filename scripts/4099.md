...
children:       
poster:         Joel Bennett
title:          UIAutomation 1.9
date:           2013-04-11 00:00:04
description:    I really am still working on this replacement for the WASP module ;-)

This version adds the -PropertyValue parameter to Select-UIElement.  This parameter is super powerful (can do most of the other parameters) and is a temporary shortcut for not having all the other Properties as named parameters.


NOTE: Requires "Reflection":http://poshcode.org/3174 (or newer) and "Autoload":http://poshcode.org/3173 (or newer)
format:         posh
---

# UIAutomation 1.9

### [download](4099.ps1) [parent](3931.md) 
