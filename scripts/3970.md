...
description:    If you want to get an off site backup of your VM's but dont have a 2nd office and dont want to rely on tapes, then use Veeam, Amazon AWS and a few powershell snapin's to get your VM's into the cloud. This solution costs a fraction of a DR budget and the VM's can be powered on and running in an hour. 
format:         posh
---
