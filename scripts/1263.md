...
children:       2376
poster:         Joel Bennett
title:          PowerOAuth 1.0
date:           2009-08-09 22:40:31
description:    This is the *first* raw release, supports OAuth via Installed Application Authentication (a modified form of OAuth where the consumer fetches access tokens using a username and password instead of a request token). 

I'm just trying to get myself started on the whole "release early, release often" thing, and to stack up a bunch of things that I've been meaning to blog about for awhile.
format:         posh
---

# PowerOAuth 1.0

### [download](1263.ps1)  [2376](2376.md)
