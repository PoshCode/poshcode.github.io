...
poster:         Boe Prox
title:          Binary Clock
date:           2011-07-06 04:17:12
description:    This is a binary clock written in PowerShell that works just like you would expect from a binary clock. Complete with options to show the date, "human readable" time and an option to show binary values. See my blog post for more information. http://learn-powershell.net/2011/07/05/building-a-binary-clock-with-powershell/
format:         posh
---
