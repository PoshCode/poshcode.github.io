...
date:           2012-07-10 09:44:03
description:    This script takes a list of Active Directory security group membership from XML, checks a baseline, and emails results.  Code can be taken from this to create the baseline XML as well.  Thanks to Andrew M. for fixing empty group membership bug.
...
### [download](3509.ps1) [parent](3496.md) 

This script takes a list of Active Directory security group membership from XML, checks a baseline, and emails results.  Code can be taken from this to create the baseline XML as well.  Thanks to Andrew M. for fixing empty group membership bug.
