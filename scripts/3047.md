...
poster:         Joel Bennett
title:          Get-MWSOrder
date:           2011-11-10 22:21:37
description:    Get seller orders from Amazon's MWS web services ... with items optionally included.

Here's the link for getting "Amazon's OrdersClient library":https://developer.amazonservices.com/gp/mws/api.html?ie=UTF8&section=orders&group=orders&version=latest
format:         csharp
---

# Get-MWSOrder

### [download](3047.cs) [parent](3046.md) 
