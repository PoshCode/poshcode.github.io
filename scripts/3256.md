...
date:           2012-02-25 13:33:40
format:         posh
---

# DefaultParameterValues

### [download](3256.ps1) - [parent](3255.md) - children: [3739](3739.md)"

For PowerShell 3: Export and Import DefaultParameterValues, optionally overwrite existing ones

This version:

# Added (working) Enable/Disable commands to toggle *all* the Defaults on or off
# Enhanced the output of Import-DefaultParameter
# Added Get-DefaultParameter with wildcard support
# Enhanced Set-DefaultParameter with SupportsShouldProcess (-Confirm/-Whatif)
# Added Remove-DefaultParameter with wildcard support and SupportsShouldProcess (-Confirm/-Whatif)
#
