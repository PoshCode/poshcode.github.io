...
description:    SIA - SysInternals Automation. You need sigcheck and strings tools to test this concept. Note: interface localized only for English and Russian cultures (edit $res to get your native culture).
format:         posh
---
