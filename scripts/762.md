...
children:       1398
poster:         Joel Bennett
title:          Custom Accelerators CTP3
date:           2008-12-30 00:43:56
description:    A script module for CTP3 which allows the user to create their own custom type accelerators. Thanks to "Oisin Grehan for the discovery":http://www.nivot.org/2008/12/25/ListOfTypeAcceleratorsForPowerShellCTP3.aspx. 
format:         posh
---

# Custom Accelerators CTP3

### [download](762.ps1)  [1398](1398.md)

A script module for CTP3 which allows the user to create their own custom type accelerators. Thanks to "Oisin Grehan for the discovery":http://www.nivot.org/2008/12/25/ListOfTypeAcceleratorsForPowerShellCTP3.aspx. 
