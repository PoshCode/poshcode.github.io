...
My "nearly-fixed" version of Invoke-Web v 4.2 looks as follows now:
...
And now I am left with the 7th syntax error, and I can't find where for the live of me this code misses a closing curly brace?
