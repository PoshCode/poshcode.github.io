...
description:    Used as a notification command channel in SCOM, this script will (theoretically) spawn a process on a remote machine - used for creating a sound on an admin console, such as in a NOC. 
