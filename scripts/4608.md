...
description:    Displays detailed information about loaded assemblies and available static methods of classes. By default members pane is hidden, to activate it you need to press Ctrl+M. Also you can load third party assemblies for explore them. Please send me feedbacks (of corse, if you wish).
format:         posh
---
