...
pid:            3496
parent:         0
children:       3581,3536,3509
poster:         Steve Jarvi
title:          Security group monitor
date:           2012-07-02 10:59:31
description:    This script takes a list of Active Directory security group membership from XML, checks a baseline, and emails results.  Code can be taken from this to create the baseline XML as well.  Thanks to Koldkutspecial for fixing empty group membership bug.
...
### [download](3496.ps1)  [3581](3581.md) [3536](3536.md) [3509](3509.md)

This script takes a list of Active Directory security group membership from XML, checks a baseline, and emails results.  Code can be taken from this to create the baseline XML as well.  Thanks to Koldkutspecial for fixing empty group membership bug.
