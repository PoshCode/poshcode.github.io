...
children:       1326
poster:         Ken Knicker
title:          Users/Contacts from CSV
date:           2009-09-17 09:32:27
description:    Creates or updates mail-enabled users or contact objects. Developed to work within an Exchange 2003 / Windows Server 2003 environment. Depends on Quest Active Directory extensions.
REQUESTING advice for improving it. See TO DO notes within comments.	
format:         posh
---

# Users/Contacts from CSV

### [download](1325.ps1) [parent](1324.md) [1326](1326.md)
