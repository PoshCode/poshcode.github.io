...
description:    Creates a form that allows you to generate a random password based on the requirements listed within the code. Can then print out the form to give to user. Password also saved to clipboard and can be pasted into the password reset dialog.
format:         posh
---
