...
description:    Enumerate the Parameters of a command by ParameterSet, including DynamicParameters. Includes a -Full output mode and support for specifying the module.  The only Get-Parameter you need :)
format:         posh
---

# Get-Parameter

### [download](1592.ps1) [parent](1587.md) [2005](2005.md)
