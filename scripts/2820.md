...
poster:         Joel Bennett
title:          Select-ViaGUI
date:           2011-07-24 21:43:34
description:    An interactive graphical filter for pipeline objects for "ShowUI":http://showui.codeplex.com/
As an improvement over the currently shipped one, this one now has columns ... in 1.2 we'll ship one with sortable columns ;-)
format:         posh
---

# Select-ViaGUI

### [download](2820.ps1) [parent](2646.md) 

An interactive graphical filter for pipeline objects for "ShowUI":http://showui.codeplex.com/
As an improvement over the currently shipped one, this one now has columns ... in 1.2 we'll ship one with sortable columns ;-)
