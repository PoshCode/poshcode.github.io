...
children:       
poster:         Paul Drinnon
title:          AnalizeScript.ps1
date:           2011-03-24 08:08:06
description:    AnalizeScript opens a dialog box for user selection; checks that input is a powershell script; parses and agrigates the script components.
format:         posh
---
