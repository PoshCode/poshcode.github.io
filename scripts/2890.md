...
children:       
poster:         APetrovskiy
title:          Log ports used by app
date:           2011-08-04 14:07:16
description:    This script reports ports used by applications under test. Both inbound and outbound connections are recorded. 
...
Report format:
hostname `t datetime `t application `t netstat string

v 1.1 supports also squeezing by hostnames, ip addresses and other string fragments
      in such cases the PID is resolved to process name and added to the report
format:         posh
---

# Log ports used by app

### [download](2890.ps1) [parent](2889.md) 
