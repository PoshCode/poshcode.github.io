...
children:       
poster:         Joel Bennett
title:          PresentationFrame.xaml
date:           2010-08-25 12:54:46
description:    A required file for my "PowerShell Presentation module":http://poshcode.org/2105
format:         xml
---
				...
				<ControlTemplate TargetType="{x:Type MenuItem}">
					<Grid>
						...
						<Grid x:Name="Panel" HorizontalAlignment="Right" Width="26" Background="Transparent">
							<Border x:Name="HighlightBorder" SnapsToDevicePixels="True" Visibility="Hidden" BorderBrush="#B0B5BACE" BorderThickness="1,1,1,1" CornerRadius="2">
								<Border.Background>
