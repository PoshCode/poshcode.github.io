...
poster:         Shay Levy
title:          
date:           2010-07-18 02:45:28
description:    Fixed minor issue (original: http://poshcode.org/1817) where a cmdlet doesn't have built-in parameters (e.g Exit-PSSession)
format:         posh
---
