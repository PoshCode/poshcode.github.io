...
title:          EFT Module
date:           2013-08-07 20:17:45
description:    The beginning of a Module for EFT server. PowerShell functions that use the SFTPCOMInterface.CIServer class to invoke methods and properties of the EFT server.
format:         posh
---
