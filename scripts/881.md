...
date:           2009-02-19 13:42:06
description:    Ported TabExpansion from V2CTP2 to V2CTP3 and extended. Please dot souce this script file to use.
...
Default help function and its alias(man) now support topics and command expansion (with/without -Name parameter), and category expansion with -Category parameter
...
### [download](881.ps1) [parent](847.md) [913](913.md)
