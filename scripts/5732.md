...
children:       
poster:         TheBigBear
title:          Invoke-Web 4.2
date:           2015-02-12 09:25:56
description:    Powershell 3 & 4 complain about this code having syntax issues. I tried 'fixing' it, but I am "stuck" now. I think I fixed the first six, but have one left that I just can't figure, so I probably made a mistake when trying to fix the first six.

I also raiseed this issue as Issue #17 (Invoke-Web 4.2 poshcode ID 3913 (by Joel Bennett) is corrupt?) on github's poshcode repo.
https://github.com/PoshCode/PoshCode/issues/17
...
### [download](5732.ps1) [parent](3913.md) 

Powershell 3 & 4 complain about this code having syntax issues. I tried 'fixing' it, but I am "stuck" now. I think I fixed the first six, but have one left that I just can't figure, so I probably made a mistake when trying to fix the first six.
