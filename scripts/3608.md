...
poster:         Huajun Gu
title:          New-XVM
date:           2012-09-04 19:12:29
description:    This is a script which I have used prepared my lab environment with Hyper-V 3.0 in Windows Server 2012. I have tested it with Windows Server 2012 RC.
I will test it again after upgrading my lab to Windows Server 2012 RTM.

You may extended this script to support more configurations.
I know MemoryStartupBytes and BootDevice is not enough. There are a lot of new features in Hyper-V 3.0, right? :)
Like VLAN ID, Bandwidith Management, Resource control and so on.
format:         posh
---

# New-XVM

### [download](3608.ps1)  [3609](3609.md)

This is a script which I have used prepared my lab environment with Hyper-V 3.0 in Windows Server 2012. I have tested it with Windows Server 2012 RC.
I will test it again after upgrading my lab to Windows Server 2012 RTM.
