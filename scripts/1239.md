...
date:           2009-07-28 13:14:09
description:    Updated for PowerBoots 0.2: http://screencast.com/t/drKhZbMv0S A stay-on-top (borderless window) countdown timer, with a percentage-based color progress bar as well as sizable font ... as well as audio file and voice alarms. 

* Refactored functions into main window
* Fixed bad variable typo
format:         posh
---

# Start-BootsTimer

### [download](1239.ps1) [parent](1218.md) 
