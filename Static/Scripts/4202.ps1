...
###################################################################################################
## History
@@## v 2.7 Fix double prompting issue when using -Inline and fix unknown type error for PSCredential
...
process {
   # Use fully qualified name for PSCredential 
...
@@    # without the else, get double prompting with Inline
      else {
