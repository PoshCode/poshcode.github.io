...
pid:            5586
author:         Carl Reid
title:          Minor updated version
date:           2014-11-13 17:49:56
format:         posh
parent:         5400
...
### [download](//scripts/5586.ps1) - [parent](//scripts/5400.md)

Generates an CSR certificate request powershell

Modification of original version submitted by Pavel_Kandratsyeu@epam.com
...
Friendly name and description can be specified from parameters
