---
pid:            3679
author:         Kerry Boomsliter
title:          Split-Job V 1.2.1
date:           2012-10-04 13:06:52
format:         posh
parent:         2621
...
### [download](//scripts/3679.ps1) - [parent](//scripts/2621.md)
...
-- Modified the $Script building lines to remove the "empty pipe" error when running
-- or sourcing in PS 3 command line, PS 3 ISE and really everything else except PowerGUI.
