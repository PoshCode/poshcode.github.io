...
### [download](//scripts/5531.ps1) - [parent](//scripts/5528.md)

Opens a function in a text editor....
Can now handle editing any command that resolves to a script *or* a function, and also supports file paths.

Help is woefully out of date again, I'll fix that in the next version.
