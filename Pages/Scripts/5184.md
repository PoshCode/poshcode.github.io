...
### [download](Scripts\5184.ps1) - [parent](Scripts\5183.md)

Bulk converts XLS ranges to PNG by using the clipboard. Reads config from XML. Now with working code... :P
