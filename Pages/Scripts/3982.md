...
### [download](Scripts\3982.sh)

This script is analog of Sysinternals hex2dec but with additional feature – interactive mode. At last it has been wrote on command language, no C\C++ (v2.03: moved some useless strings).
